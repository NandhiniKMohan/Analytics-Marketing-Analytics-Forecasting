---
title: "Forecast_Stock_AutoArima"
...
#auto.arima automatically chooses the best fit model
...
lines(forecasted_series, lwd=1.5, col='green')
#legend('bottomright', c("Actual", "Forecasted"), lty=c(1,1), lwd=c(1.5,1.5), col=c('black', 'red'))

legend('bottomright', legend=c("Actual", "Forecasted"), lty=c(1,1), lwd=c(1.5,1.5), col = c("blue","green"))
```
...
```{r}
Accuracy_percentage_2= sum(comparison$Accuracy ==1)*100/length(comparison$Accuracy)
print(paste("Accuracy Percentage using the fittest model by auto.arima: " ,Accuracy_percentage_2))
```
##Accuracy of (2,0,2) Arima Model: 44.4445%
##Accuracy on using auto.arima: 55.5556%
